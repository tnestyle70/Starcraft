...
class CCitadelOfAdun : public CBuilding, public Commandable
{
public:
	CCitadelOfAdun();
	virtual ~CCitadelOfAdun();
public:
...
protected:
	...
	int GetRequiredTileValue() const override { return 5; } //파일런 파워 
private:
	void BuildCombatStation();
	void BuildNuclearSilo();
	void UpdateProduction();
	void ProductionComplete(eCommandID command);
	void WarpGateComplete(eCommandID command);
	void UseScanner();
private:
