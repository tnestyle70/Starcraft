...
void CObserver::Render(HDC hDC)
{
    ...
    TCHAR szKey[256];
    wsprintf(szKey, L"Observer_Move_%d", fileIndex);
...
void CObserver::Release()
{
}

void CObserver::UpdateHotKeys()
{
    CUnit::UpdateHotKeys();
}

bool CObserver::ExecuteCommand(eCommandID command, CommandContext& context)
{
    //먼저 부모 명령 실행
...
void CObserver::CommandCardSlot(vector<CommandSlot>& outSlot)
{
