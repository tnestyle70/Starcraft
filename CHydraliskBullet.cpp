...
CHydraliskBullet::CHydraliskBullet()
{
}
...
void CHydraliskBullet::Initialize()
{
    __super::Initialize();
...
void CHydraliskBullet::Render(HDC hDC)
{
    ...
    // ========== PNG 애니메이션 방식으로 렌더링 ==========
    TCHAR szKey[256];
    wsprintf(szKey, L"Hydralisk_Attack%d_Bullet%d", m_tFrame.iFrame, m_tFrame.iStart);
...
void CHydraliskBullet::Release()
{
}

void CHydraliskBullet::CreateEffect()
{
    //이펙트 생성
