...
void CFactoryAddOn::Initialize()
{
	...
	m_pFrameKey = L"FACTORY_ADDON_ANIM";
...
void CFactoryAddOn::SetBuildingData()
{
	m_eType = eBuildingType::FACTORY_ADDON;
	//비용, 스탯
	m_tCost.mineral = 100;
	m_tCost.gas = 0;
	m_tCost.supply = 0;
...
void CFactoryAddOn::Render(HDC hDC)
{
...
void CFactoryAddOn::Release()
{
}

void CFactoryAddOn::RenderSlot(HDC hDC, int slotIndex)
{
}

int CFactoryAddOn::GetIconIndex(eCommandID eCommand)
{
	return 0;
}

void CFactoryAddOn::CommandCardSlot(std::vector<CommandSlot>& outSlot)
{
...
bool CFactoryAddOn::ExecuteCommand(eCommandID command, CommandContext& context)
{
	//건물이 다 지어진 이후에 건설 가능
...
void CFactoryAddOn::UpdateHotKeys()
{
...
void CFactoryAddOn::UpdateAnimation()
{
	if (m_bProducing) 
	{
...
void CFactoryAddOn::UpdateProduction()
{
...
void CFactoryAddOn::ConstructComplete(eCommandID command)
{
	//인구수 올리기
	/*
...
void CFactoryAddOn::Destroy()
{
	m_eState = eBuildingState::DESTROY;
}

void CFactoryAddOn::PlayCompleteSound()
{
